...
class _ShoppingPageState extends State<ShoppingPage> {
  ...
  final List<Map<String,dynamic>> categories = [
    ...
    {'label': 'Medicine', 'color': Colors.blueGrey, 'icon': Icons.medical_services},
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // TODO: Add title with style (Poppins)
            ...
            itemBuilder: (context,index) {
              ...
              return ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => ItemsCategoryDisplay(
                          category: category['label'], // Match firestore category field
